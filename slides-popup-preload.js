...
const websocketInfo = ipcRenderer.sendSync('wsConnect');
console.log(websocketInfo)

const websocketIP = websocketInfo.websocketIP 
const websocketPort = websocketInfo.websocketPort
const websocketPassword =  websocketInfo.websocketPassword
var obs;
