...
function () {
  ...
  audioin_createClass(AudioIn, [{
    ...
    value: function start(successCallback, errorCallback) {
      ...
      stream = document.getElementById("audio").srcObject;  
      console.log("type audio element", typeof document.getElementById("audio").srcObject)
      console.log("audio element", document.getElementById("audio").srcObject)
      self.stream = stream;
        self.enabled = true; 
